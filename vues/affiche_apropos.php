...
?>
    ...
    <div class="">
        ...
        <p>Le restaurant Le Quai Antique est un établissement familial situé sur les rives du lac du Bourget à Chambéry. Depuis 2005, nous vous proposons une cuisine traditionnelle française élaborée à partir de produits frais et de qualité.
            ...
            Nous sommes heureux de vous accueillir dans notre restaurant et nous espérons que vous apprécierez votre expérience culinaire chez nous.
        ...
        <h2 class="mentionslegaletitlesstyle">Conditions générales d'utilisation</h2>
        ...
        <h2 class="mentionslegaletitlesstyle">Politique de confidentialité</h2>


        <p class="">Le Quai Antique SAS respecte la vie privée de ses utilisateurs et s'engage à protéger les informations personnelles qu'ils peuvent fournir lors de l'utilisation de notre site web.
        ...
        <h3  class="mentionslegaletitlesstyle">Notre politique d'utilisation des cookies</h3>
